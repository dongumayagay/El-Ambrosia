...
<div class="drawer-side">
	...
	<div class=" menu w-80 bg-base-100 text-base-content">
		...
		<nav class="flex flex-col flex-1 gap-4 p-4 pt-0">
			...
			<a on:click class="gap-2 btn" href="/admin/orders">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					fill="none"
					viewBox="0 0 24 24"
			...
			<a on:click class="gap-2 btn" href="/admin/supplies"
				><svg
					xmlns="http://www.w3.org/2000/svg"
					fill="none"
					viewBox="0 0 24 24"
			...
			<a on:click class="gap-2 btn" href="/admin/users"
				><svg
					xmlns="http://www.w3.org/2000/svg"
					fill="none"
					viewBox="0 0 24 24"
			...
			<a on:click class="gap-2 btn" href="/admin/support"
				><svg
					xmlns="http://www.w3.org/2000/svg"
					fill="none"
					viewBox="0 0 24 24"
			...
			<button on:click={logout} class="gap-2 btn-error btn btn-outline btn-primary"
				><svg
					xmlns="http://www.w3.org/2000/svg"
					fill="none"
					viewBox="0 0 24 24"
