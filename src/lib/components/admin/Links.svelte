<li>
	<a href="/admin" for="admin-drawer" class="btn btn-link font-medium">
		<svg
...
<li>
	<a href="/admin/supply" class="btn btn-link font-medium">
		<svg
			width="24"
			height="24"
			xmlns="http://www.w3.org/2000/svg"
...
<li>
	<a href="/admin/orders" class="btn btn-link font-medium">
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
			viewBox="0 0 24 24"
...
<li>
	<a href="/admin/support" class="btn btn-link font-medium">
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
			viewBox="0 0 24 24"
...
<li>
	<a href="/admin/users" class="btn btn-link font-medium">
		<svg
			xmlns="http://www.w3.org/2000/svg"
			fill="none"
			viewBox="0 0 24 24"
